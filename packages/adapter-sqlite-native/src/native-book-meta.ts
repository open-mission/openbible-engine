...
// Kept in the Native service graph so the static compiler does not need to
// traverse the engine-core package's wider export surface.
export const NATIVE_BOOKS: readonly NativeBook[] = [
